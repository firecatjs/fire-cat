...
exports.FireCatDecorator = void 0;
var FireCatDecorator = (function () {
    function FireCatDecorator() {
    }
    FireCatDecorator.register = function (props) {
        return function (target, propertyKey, descriptor) {
            var original = descriptor.value;
            var saveKey = 'fn_' + propertyKey + '_save';
            if (!target[saveKey]) {
                target[saveKey] = [];
                if (props.wrap) {

...
import { Get, Post, Del, Delete, Head, Put, Update, Patch, All, Request } from "./decorators/request";
...
export * from './types';
export { FireCat, FireCatController, FireCatRouter, FireCatLog, FireCatDecorator, FireDocument, FireCatVerify, Get, Post, Del, Delete, Head, Put, Update, Patch, All, Request, ApiDescription, FireCatVerifyWrap, createSchema, };
declare module "koa" {
    interface Request {
        body: any;
        rawBody: string;

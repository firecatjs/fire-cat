...
exports.FireCatVerify = exports.FireCatVerifyWrap = void 0;
...
function FireCatVerifyWrap(wrap) {
    return function CatVerify(jsonRule) {
        ...
        return decorator_1.FireCatDecorator.register({
            wrap: function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
                var bodyData, errors;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            bodyData = ctx.method == 'GET' ? ctx.request.query : ctx.request.body;
                            errors = (0, fastValidator_1.fastValidator)(bodyData, jsonRule);
...
exports.FireCatVerify = FireCatVerifyWrap(function (message, ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
